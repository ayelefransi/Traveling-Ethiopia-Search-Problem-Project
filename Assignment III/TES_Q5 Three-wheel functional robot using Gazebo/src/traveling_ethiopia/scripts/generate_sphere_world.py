#!/usr/bin/env python3
"""
Generate minimal Ethiopia world with sphere markers only.
"""
...
def generate_sphere_marker(name, x, y, color, size_mult=1.0):
    """Generate simple sphere marker."""
    model_name = name.replace(' ', '_')
    r, g, b = color
    radius = 0.2 * size_mult
...
for city_data in CITIES:
    world_content += generate_sphere_marker(*city_data)
